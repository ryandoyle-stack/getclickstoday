...
export default function ServicePage({
  title, tagline, heroSub, price, priceNote,
  includes, forYou, process, faqs, crossSell,
}) {
  useEffect(() => {
        ...
        <div className="wrap" style={{padding:'80px 52px'}}>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'64px',alignItems:'start'}} className="sp-grid">
            <div className="fade-up">
              ...
              <p style={{fontSize:'15px',color:'var(--muted)',fontWeight:300,lineHeight:1.75,marginBottom:'24px',maxWidth:'480px'}}>We don&apos;t cut corners. Here&apos;s exactly what&apos;s included:</p>
            ...
            <div className="fade-up">
              <div style={{background:'var(--bg2)',border:'2px solid var(--pink)',borderRadius:'14px',padding:'32px',position:'relative',overflow:'hidden'}}>
                ...
                <div style={{paddingTop:'24px',borderTop:'1px solid var(--border)',display:'flex',flexDirection:'column',gap:'10px'}}>
                  {['Month-to-month · No contracts','Cancel anytime, no penalties','First deliverable in 14 days','Senior strategists on every account'].map(t => (
                ...
                <a href="/#contact" style={{display:'block',marginTop:'28px',background:'var(--pink)',color:'#fff',padding:'14px 24px',borderRadius:'8px',fontSize:'14px',fontWeight:600,textDecoration:'none',letterSpacing:'0.04em',textAlign:'center',transition:'all 0.2s',boxShadow:'0 4px 16px rgba(255,45,120,0.25)'}}>
      ...
      {crossSell && (
        <section style={{background:'var(--bg)'}}>
          <div className="wrap" style={{padding:'80px 52px'}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))',gap:'1px',background:'var(--border)',border:'1px solid var(--border)',borderRadius:'12px',overflow:'hidden'}} className="fade-up">
              {crossSell.map((cs, i) => (
