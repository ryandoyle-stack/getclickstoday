        ...
        <div className="wrap">
          ...
          <div className="svc-grid-top fade-up">
            ...
            <div className="svc">
              ...
              <a href="/services/paid-ads" style={{display:'inline-block',marginTop:'18px',fontSize:'12px',color:'var(--cyan)',textDecoration:'none',letterSpacing:'0.04em'}}>Learn more →</a>
            </div>
          </div>
          <div className="svc-grid-bot fade-up" style={{marginTop:'1px'}}>
            <div className="svc">
              ...
              <a href="/services/social-media-management" style={{display:'inline-block',marginTop:'18px',fontSize:'12px',color:'var(--cyan)',textDecoration:'none',letterSpacing:'0.04em'}}>Learn more →</a>
            </div>
            <div className="svc">
              ...
              <a href="/services/seo-local-search" style={{display:'inline-block',marginTop:'18px',fontSize:'12px',color:'var(--cyan)',textDecoration:'none',letterSpacing:'0.04em'}}>Learn more →</a>
            </div>
            <div className="svc">
          ...
          <div className="svc-grid-bot fade-up" style={{marginTop:'1px'}}>
            ...
            <div className="svc">
              ...
              <a href="/services/email-marketing" style={{display:'inline-block',marginTop:'18px',fontSize:'12px',color:'var(--cyan)',textDecoration:'none',letterSpacing:'0.04em'}}>Learn more →</a>
            </div>
          </div>
        </div>
      </section>
