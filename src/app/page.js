        ...
        <div className="wrap">
          ...
          <div className="svc-grid-top fade-up">
            ...
            <div className="svc">
              ...
              <p className="svc-desc">Meta, Google, and TikTok ads managed by people who treat your budget like their own. Data-first targeting, scroll-stopping creative, conversion tracking, and weekly optimization.</p>
              ...
              <a href="/services/paid-ads" className="svc-learn">Learn more →</a>
            </div>
          </div>
          <div className="svc-grid-bot fade-up" style={{marginTop:'1px'}}>
            <div className="svc">
              ...
              <p className="svc-desc">12+ custom posts per month, done-for-you. Strategy, captions, hashtags, scheduling, community management, and monthly performance reporting.</p>
              ...
              <a href="/services/social-media-management" className="svc-learn">Learn more →</a>
            </div>
            <div className="svc">
              ...
              <p className="svc-desc">Rank where your customers are searching. Technical SEO, on-page optimization, keyword research, backlink outreach, and local citation building.</p>
              ...
              <a href="/services/seo-local-search" className="svc-learn">Learn more →</a>
            </div>
            <div className="svc">
          ...
          <div className="svc-grid-bot fade-up" style={{marginTop:'1px'}}>
            <div className="svc">
              ...
              <p className="svc-desc">Your Google Business Profile is often the first thing people see. We keep it optimized, active, and converting — weekly posts, fresh photos, Q&amp;A responses, review replies.</p>
              <div className="svc-tags">{['Weekly posts','Photos','Q&A','Review replies'].map(t=><span key={t} className="tag">{t}</span>)}</div>
            </div>
            <div className="svc">
              ...
              <p className="svc-desc">We monitor, respond to, and grow your reviews across Google, Yelp, and industry platforms so new customers trust you before they even call.</p>
            ...
            <div className="svc">
              ...
              <p className="svc-desc">A full email marketing engine. 2–4 campaigns per month, automated flows (welcome, abandoned cart, win-back), list segmentation, and A/B testing.</p>
              ...
              <a href="/services/email-marketing" className="svc-learn">Learn more →</a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bundle-hl-grid fade-up">
            <div className="bundle-hl-left">
              ...
              <div className="bundle-savings">
                <div className="savings-card"><div className="savings-big">$100</div><div className="savings-label">Saved w/ 2 services</div></div>
                <div className="savings-card"><div className="savings-big">$225</div><div className="savings-label">Saved w/ 3 services</div></div>
                <div className="savings-card"><div className="savings-big">$300</div><div className="savings-label">Saved w/ 4 services</div></div>
                <div className="savings-card"><div className="savings-big">$3,600</div><div className="savings-label">Saved per year (max)</div></div>
              </div>
              <a href="#pricing" className="btn-primary">See all bundles →</a>
            </div>
        ...
        <div className="wrap">
          ...
          <div className="ind-layout fade-up">
            ...
            <div id="ind-dental" className="ind-panel">
              ...
              <p className="ind-body">Cosmetic dentistry marketing is a game of trust and visibility. We help SoFlo practices rank for high-intent local searches, run Meta campaigns that showcase before/afters, and build the online reputation that turns first-time visitors into lifetime patients.</p>
              <div className="ind-results">
        ...
        <div className="wrap">
          ...
          <div className="price-panel" id="price-projects">
            <div className="proj-grid fade-up">
              {[
                ['Website','Landing Page','$1,500','One high-converting page. Perfect for a campaign, product launch, or service offering.',['Custom design + mobile-first build','Contact form + CTA optimization','Basic SEO setup','30-day post-launch support'],false],
                ['Website · Most popular','Business Site','$2,000–$2,500','A complete business website — up to 6 pages, built to rank on Google and convert visitors.',['Up to 6 custom pages','Full SEO setup + sitemap','Contact form + Calendly embed','Google Analytics setup','30-day post-launch support'],true],
                ['Website','Ecommerce Store','$3,000+','A full online store built to sell. Product pages, checkout flow, payment processing.',['Shopify or custom build','Product catalog setup','Stripe / payment integration','Email capture + abandoned cart','Custom scoped per project'],false],
            ...
            <div className="proj-grid fade-up" style={{marginTop:'1px'}}>
              {[
                ['Brand','Brand Strategy','$1,200–$1,800','Positioning, messaging framework, and brand voice guidelines.',['Discovery + competitive analysis','Positioning statement','Messaging hierarchy doc','Brand voice guidelines']],
                ['Brand','Full Brand Identity','$2,000–$2,500','Brand Strategy plus visual identity — logo direction, color palette, typography.',['Everything in Brand Strategy','Logo concepts (3 directions)','Color + typography system','Brand standards PDF']],
                ['Custom','Not sure? Let\'s talk.','Custom','Have a project that doesn\'t fit a box? We scope custom engagements.',['Campaign strategy + execution','Content audits','Ad account audits','SEO audits + roadmaps']],
      ...
      <section id="testimonials" style={{background:'var(--bg)'}}>
        <div className="wrap">
          ...
          <div className="testi-featured fade-up">
            <div>
              <div className="testi-stars">★★★★★</div>
              <div className="testi-featured-quote">&ldquo;We&apos;d tried two other agencies before. Both overpromised and underdelivered. GetClicksToday actually showed us <em>what they were doing</em> and why — and then the results came.&rdquo;</div>
